...
KEYWORDS_CARGO_FORTE = [
    ...
    "Desenvolvedor Node Júnior",
    "Desenvolvedor Node Jr",
    "Desenvolvedor TypeScript Júnior",
    "Desenvolvedor TypeScript Jr",
    "Desenvolvedor Next.js Júnior",
    "Desenvolvedor Next.js Jr",
    "Desenvolvedor NestJS Júnior",
    "Desenvolvedor NestJS Jr",
